...
class Globber:
    ...
    def __iter__(self):
        ...
        """Get an iterator of :class:`fs3.glob.GlobMatch` objects."""
...
class BoundGlobber:
    """A `~fs3.glob.Globber` object bound to a filesystem.

    An instance of this object is available on every Filesystem object
    as the `~fs3.base.FS.glob` property.
