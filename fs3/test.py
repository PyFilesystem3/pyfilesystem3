...
import fs3.copy
import fs3.move
from fs3 import ResourceType, Seek, errors, glob, walk
from fs3.opener import open_fs
from fs3.subfs import ClosingSubFS, SubFS
...
class FSTestCases:
    ...
    def destroy_fs(self, fs):
        ...
        Arguments:
            fs (FS): A filesystem instance previously opened
                by `~fs3.test.FSTestCases.make_fs`.
    ...
    def test_readbytes(self):
        ...
        all_bytes = b"".join(n.to_bytes(1, "little") for n in range(256))
